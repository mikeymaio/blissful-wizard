        ...
        <div className="hero-body">
          <div className="container">
            <div className="columns is-mobile" style={{ marginBottom: "60px", margin:"0", padding:"10px" }}>
              <div className="column is-2-desktop is-6-mobile" style={{ width: 'auto' }}>
                <label htmlFor="sortBy" className="has-text-weight-bold is-uppercase">SORT BY :
                  <div className="field">
              ...
              <div className="column is-2-desktop is-6-mobile" style={{ width: 'auto' }}>
                <label htmlFor="filter" className="has-text-weight-bold is-uppercase">FILTER BY :
                  <div className="field">
                    <div className="control">
                      <div className="select">
                        <select
                ...
                context.filteredType === 'all'
                  ? products
                    ...
                    .map((p, i) => {
                      let product = p
                      return (
                        <div className="column is-full-mobile is-half-tablet is-one-third-desktop" style={{ marginBottom: "20px" }} key={i}>
                  ...
                  : products
                    ...
                    .map((p, i) => {
                      let product = p
                      return (
                        <div className="column is-one-third-desktop is-half-tablet is-full-mobile" style={{ marginBottom: "20px" }} key={i}>
                          <ProductBox product={product} />
                        </div>
                      )
                    })}
